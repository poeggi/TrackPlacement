...
//               set to false to log only to console (operators still see !tp lastoffenders).

export const chat_alerts = true;

export const tracked_blocks = [
    { id: "minecraft:tnt",            label: "TNT",            alert_color: "\u00a7c", window_ticks: 200 },
    { id: "minecraft:respawn_anchor", label: "Respawn Anchor", alert_color: "\u00a7d", window_ticks: 0 },
    ...
    // { id: "minecraft:light_blue_bed", label: "Bed (Light Blue)", alert_color: "\u00a7e", window_ticks: 0, dimensions: ["minecraft:nether", "minecraft:the_end"] },
    ...
    // { id: "minecraft:light_gray_bed", label: "Bed (Light Gray)", alert_color: "\u00a7e", window_ticks: 0, dimensions: ["minecraft:nether", "minecraft:the_end"] },
